...
public class NoAdmin extends Usuario {
    ...
    public NoAdmin(int identificacion, Cancion noAdminCancion, ListaReproduccion noAdminLista, Album noAdminAlbum, Persona personas, int edad, String correo, String nombreUsuario, String contrasenna) {
