...
public class Controlador {
    ...
    private void procesarLogin(int opcion) {
        switch (opcion) {
            case 1:
                ejecutarMenuAdmin();
                break;
    ...
    private ListaReproduccion crearListaRepro() {
    ...
    private Compositor crearCompositor() {
    ...
    private AlbumArtista crearAlbumArtista() {
        interfaz.imprimirMensaje("Nombre del Album");
